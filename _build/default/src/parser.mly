...
processes =
  | PINACT                                        { PInact Loc.dummy }
  | ident                                         { PVar ($1, Loc.dummy) }
  | REC ident DOT processes                       { PRec ($2, $4, Loc.dummy) }
  | int_lit                                       { PInt ($1, Loc.dummy) }
  | ident LBRACE expression RBRACE DOT processes  { PSend ($1, $3, $5, Loc.dummy) }
  | ident LPAREN ident RPAREN DOT processes       { PRecv ($1, $3, $5, Loc.dummy) }
 */
